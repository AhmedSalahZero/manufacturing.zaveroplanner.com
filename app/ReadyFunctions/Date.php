...
class Date
{
	protected function getMonthEndDate(float $yearOfEndDate, float $monthOfEndDate, string $dateFormat = 'Y-m-d'):string
	{
	...
	public function generateDatesBetweenTwoDates(Carbon $start_date, Carbon $end_date, $method = 'addMonthsNoOverflow', $format = 'Y-m-d', string $day = null)
	{
