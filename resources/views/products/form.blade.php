...
<div class="formItem">
    <div class="col-12">
        ...
        <div class="row">
            ...
            <?php $yearAsTwoNumbers = date('y',strtotime('01-01-'.$year)); ?>
            <?php $rate_name = 'labor_cost_'.$count_name."_rate"?>
            <div class="{{$project->duration == 1 ? "col-12" : "col-6"}}">
                <div class="form-group">
                    <label>{{__('Yr-').$yearAsTwoNumbers}} (%)<span class="red">*</span></label>
                    <input type="number" step="any" class="form-control @error($rate_name) is-invalid @enderror" name="{{$rate_name}}" value="{{isset($product->$rate_name) ? $product->$rate_name :old($rate_name)}}" id="{{$rate_name}}" placeholder="{{__('Rate %')}}">
                    @error($rate_name)
                    <div class="alert alert-danger" role="alert">
                        {{$message}}
                    </div>
...
{{-- <div class="projectItem">
    {{__('Manufacturing Overheads Cost Rate %')}}
</div>
<div class="formItem">
    <div class="col-12">
        @error('product_cost_rate')
        ...
        <div class="row">
            ...
            <?php $count_name = array_key_first($data) ; $year = $data[$count_name];?>
            <?php $yearAsTwoNumbers = date('y',strtotime('01-01-'.$year)); ?>
            <?php $rate_name = 'moh_cost_'.$count_name."_rate"?>
            <div class="{{$project->duration == 1 ? "col-12" : "col-6"}}">
                <div class="form-group">
                    <label>{{__('Yr-').$yearAsTwoNumbers}} (%)<span class="red">*</span></label>
                    <input type="number" step="any" class="form-control @error($rate_name) is-invalid @enderror" name="{{$rate_name}}" value="{{isset($product->$rate_name) ? $product->$rate_name :old($rate_name)}}" id="{{$rate_name}}" placeholder="{{__('Rate %')}}">
...
{{-- <div class="div-title toggle-show-hide" data-query=".comment-for-raw-material-class">
    {{__('Insert Comment For Raw Materials')}}
</div>
<div class="formItem comment-for-raw-material-class">
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="form-group ">
                <textarea data-is-ck-editor name="comment_for_raw_material">{!! $product->comment_for_raw_material !!}</textarea>
            </div>
        </div>
