        ...
        <div class="container">
            <div class="left-section">
                <div class="inner-content">
                    ...
                    <p class="subheading">{{isset($message['en']) ? $message['en'] : 'Looks like the page you were looking for is not Found'}}</p>
                    <p class="subheading">{{isset($message['ar']) ? $message['ar'] : '.يبدو أن الصفحة التي تبحث غير موجودة'}}</p>
                </div>
            </div>
